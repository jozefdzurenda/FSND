...
class TriviaTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.database_path = "postgresql://{}:{}@{}/{}".format(os.environ.get(
            'DB_USER'), os.environ.get('DB_PASSWORD'), 'localhost:5432', self.database_name)
        ...
        self.new_question_valid = {
            "question": "TEST Q", "answer": "TEST A", 'category': 3, "difficulty": 5}
        self.new_question_invalid_category = {
            "question": "TEST Q", "answer": "TEST Q", 'category': 300, "difficulty": 5}
        self.new_question_missing_question = {
            "question": None, "answer": "TEST Q", 'category': 3, "difficulty": 5}
    ...
    def test_quiz_no_more_questions(self):
        res = self.client().post("/quizzes",
                                 json={'quiz_category': {'id': 1}, 'previous_questions': [i for i in range(1000)]})
        data = json.loads(res.data)
